...
<head>
  ...
  ================================================== -->
	<meta charset="utf-8">
	<title><?php if (isset($_GET['article'])) { echo $matches[1]; } else { ?> gravity <?php } ?></title>
	<meta name="description" content="You got to the site with various essays">
...
<body class="home-page">
	<div class="wrap-body">
		<header class="">
			<div class="logo">
				<a href="/">gravity</a>
				<span>You got to the site with various essays</span>
			</div>
			<div id="cssmenu" class="align-center">
				<ul>
					<li class="last"><a href="./"><span>Main</span></a></li>
			...
			<div id="owl-slide" class="owl-carousel">
				<div class="item">
					<img src="img/themes/space/6030933-www.nevseoboi.com.ua.jpg" />
				</div>
				<div class="item">
					<img src="img/themes/space/1000627-space-nevseoboi.com.ua.jpg" />
				</div>
				<div class="item">
					<img src="img/themes/space/6037210-www.nevseoboi.com.ua.jpg" />
				</div>
			</div>
		</header>
		<!--////////////////////////////////////Container-->
		...
		<footer>
			<div class="zerogrid bottom-footer">
                ...
                <div>
                    <p align="center">
                        <a href="./?a=4">Privacy policy</span></a>
                    </p>
                </div>
				<div class="copyright">
					Copyright @ - <a href="./">gravity</a>
				</div>
			</div>
		</footer>
		<!-- carousel -->
